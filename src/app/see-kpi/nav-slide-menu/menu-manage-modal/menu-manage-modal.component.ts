...
export class MenuManageModalComponent implements OnInit, OnDestroy {
  ...
  openAddMenuDialog(group: object): void {
    ...
    const addEditMenuRef = this.dialog.open(AddEditMenuDialog, this.functionSetting.modalSetting(true, "", data));
  ...
  delMenu(menuId: Number, menuName: string) {
    ...
    const deleteMenuRef = this.dialog.open(DeleteMenuDialog, this.functionSetting.modalSetting(true, "", data));
